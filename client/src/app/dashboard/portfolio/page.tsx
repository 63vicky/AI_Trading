    ...
    <div className="flex-1 space-y-4 p-4 md:p-8 pt-6">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold text-green-600">+$3,352.14</div>
            <p className="text-xs text-muted-foreground">
              +4.5% from last week
            </p>
          </CardContent>
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-xs text-muted-foreground">3 pending orders</p>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          ...
          <CardContent>
            <div className="space-y-8">
              <div className="flex items-center">
                ...
                <div className="ml-auto font-medium">$20,354.35</div>
              </div>
              <div className="flex items-center">
                <div className="ml-4 space-y-1">
                ...
                <div className="ml-auto font-medium">$15,824.23</div>
              </div>
              <div className="flex items-center">
                <div className="ml-4 space-y-1">
                ...
                <div className="ml-auto font-medium">$9,053.31</div>
              </div>
            </div>
          </CardContent>
        </Card>
